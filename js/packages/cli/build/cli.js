...
commander_1.program
    ...
    var extension, keypair, cacheName, ENV, cachePath, savedContent, cacheContent, existingInCache, seen, newFiles, images, SIZE, walletKey, solConnection, walletWrapper, provider, idl, anchorProgram, config, i, image, imageName, index, storageCost, link, manifestPath, manifestContent, manifest, manifestBuffer, res, exx_1, instructions, tx, data, result, metadataFile, er_1, keys, e_1;
    var _a, _b, _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                ...
                ENV = commander_1.program.getOptionValue('env') || 'devnet';
            ...
            case 15:
                ...
                return [4 /*yield*/, Promise.all(chunks(Array.from(Array(keys.length).keys()), 1000).map(function (allIndexesInSlice) { return __awaiter(void 0, void 0, void 0, function () {
                        var offset, indexes, onChain, ind;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    offset = 0;
...
commander_1.program
    ...
    var ENV, solConnection, keypair, cacheName, cachePath, cachedContent, date, secondsSinceEpoch, walletKey, walletWrapper, provider, idl, anchorProgram, _a, candyMachine, tx;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 2:
                _a = __read.apply(void 0, [_b.sent(), 1]), candyMachine = _a[0];
...
commander_1.program
    ...
    .option('-e, --env <name>', 'Environment')
    .action(function (directory, cmd) { return __awaiter(void 0, void 0, void 0, function () {
    var ENV, solConnection, keypair, solPriceStr, lamports, cacheName, cachePath, cachedContent, walletKey, walletWrapper, provider, idl, anchorProgram, config, _a, candyMachine, bump;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ENV = commander_1.program.getOptionValue('env') || 'devnet';
                ...
                lamports = Math.ceil(parseFloat(solPriceStr) * web3_js_1.LAMPORTS_PER_SOL);
                cacheName = commander_1.program.getOptionValue('cacheName') || 'temp';
                cachePath = path.join(CACHE_PATH, cacheName);
                cachedContent = fs.existsSync(cachePath)
                    ? JSON.parse(fs.readFileSync(cachePath).toString())
...
commander_1.program
    ...
    .option('-e, --env <name>', 'Environment')
    .action(function (directory, cmd) { return __awaiter(void 0, void 0, void 0, function () {
    var ENV, solConnection, keypair, cacheName, cachePath, cachedContent, mint, walletKey, token, walletWrapper, provider, idl, anchorProgram, config, _a, candyMachine, candy, metadata, masterEdition, tx, _b, _c, _d, _e;
    var _f, _g;
    return __generator(this, function (_h) {
        switch (_h.label) {
            ...
            case 2:
                ...
                return [4 /*yield*/, getCandyMachine(config, cachedContent.program.uuid)];
            case 3:
                _a = __read.apply(void 0, [_h.sent(), 1]), candyMachine = _a[0];
...
commander_1.program
    ...
    var ENV, solConnection, cacheName, cachePath, cachedContent, config, keys, i, key, thisSlice, name_1, uri, cacheItem;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ENV = commander_1.program.getOptionValue('env') || 'devnet';
